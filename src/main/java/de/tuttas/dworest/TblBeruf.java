...
@NamedQueries({
    ...
    , @NamedQuery(name = "TblBeruf.findByAbteilung", query = "SELECT NEW de.tuttas.dworest.helper.Beruf(t.bId,t.berufname,t.iDAbteilung) FROM TblBeruf t JOIN TblAbteilung ta ON t.iDAbteilung=ta.aId WHERE ta.aId = :AId")
